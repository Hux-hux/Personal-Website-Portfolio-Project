...
function runGame() {
    ...
    let result = compareInputs(userInput, aiChoice);
...
//GAME RUNNING
let pressGo = document.getElementById('choice');

pressGo.addEventListener('submit', function(event) {
